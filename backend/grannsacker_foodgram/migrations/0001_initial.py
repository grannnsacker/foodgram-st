    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Время приготовления должно быть не менее 1 минуты')], verbose_name='Время приготовления (в минутах)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_ingredients', to='grannsacker_foodgram.ingredient', verbose_name='Ингредиент')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_ingredients', to='grannsacker_foodgram.recipe', verbose_name='Рецепт')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(through='grannsacker_foodgram.RecipeIngredient', to='grannsacker_foodgram.ingredient', verbose_name='Ингредиенты рецепта'),
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorited_by', to='grannsacker_foodgram.recipe', verbose_name='Рецепт')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cart_by', to='grannsacker_foodgram.recipe', verbose_name='Рецепт')),
            ],
            options={
