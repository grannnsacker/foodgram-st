...
from grannsacker_foodgram.models import Subscription, Recipe
from grannsacker_foodgram.serializers import (
    UserSerializer,
    UserCreateSerializer,
    SubscriptionsSerializer,
    UpdatePasswordSerializer, ChangeAvatarSerializer,
...
class UserViewSet(DjoserUserViewSet):
    """ViewSet for user operations with Djoser integration."""
    ...
    def subscribe(self, request, id=None):
        """Subscribe to or unsubscribe from a user."""
        user = request.user
...
class SubscriptionsViewSet(viewsets.ReadOnlyModelViewSet):
    """ViewSet for listing user subscriptions."""
